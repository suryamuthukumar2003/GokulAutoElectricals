...
function ServiceSection() {
  return (
    <div className='container mb-24 flex flex-col space-y-14' id='service'>
      ...
      <p className='text-xs text-slate-500 text-center'>We pride ourselves on being your one-stop solution for a wide range of automotive electrical services , premium Amaron battery sales and service.</p>
      </div>
